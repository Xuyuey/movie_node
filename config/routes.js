...
module.exports = function(app){
    ...
    app.post('/admin/movie/new', User.signinRequired, User.adminRequired, Movie.savePoster, Movie.post)
    ...
    app.post('/admin/category/', User.signinRequired, User.adminRequired, Category.post)
